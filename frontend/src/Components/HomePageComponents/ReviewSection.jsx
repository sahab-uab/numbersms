    ...
    <div className="container mx-auto px-6">
      ...
      >
        ...
        <p className="text-lg md:text-xl text-gray-700 max-w-3xl mx-auto">
          ...
          empowering individuals with the knowledge and tools to excel in their
          careers and transform the world.
        </p>
      </motion.div>
      ...
      >
        ...
        >
          ...
          <h3 className="text-2xl font-semibold text-orange-600 mb-4">Focus</h3>
          <p className="text-gray-600">
            Our primary focus is on building long-term, value-driven
            relationships with our clients while delivering exceptional results.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-600">
            Our mission goes beyond borders, helping individuals and businesses
            around the world achieve success and make a lasting impact.
          </p>
        </motion.div>
      </motion.div>
